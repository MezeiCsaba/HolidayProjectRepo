...
public class SecurityConf extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSec) throws Exception {
		httpSec.authorizeRequests()
				.antMatchers("/css/**", "/js/**", "/images/**","/pics/**").permitAll()
				...
				.antMatchers("/users/**","/registration","/reg").hasAnyAuthority("ADMIN","HR")
				.antMatchers("/events/**","/calendar","/userInfoPage/**").hasAuthority("HR")
